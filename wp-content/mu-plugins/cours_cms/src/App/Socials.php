...
class Socials extends ControllerAbstract
{
    /** @var array|null Cache des champs socials */
    ...
    public static function init(): void
    {
        if (function_exists('acf_add_options_sub_page')) {
            acf_add_options_sub_page([
                'page_title' => __('Configuration Réseaux sociaux', 'app'),
                'menu_title' => __('Réseaux sociaux', 'app'),
    ...
    /**
     * Injecte les champs Socials dans le contexte Timber (socials).
     */
    public static function addToContext(array $context): array
    {
        $fields = self::getFields();
        $context['socials'] = is_array($fields['socials'] ?? null) ? $fields['socials'] : [];
        return $context;
    }

    public static function add_to_twig($twig): \Twig\Environment
    {
        $twig->addFunction(new TwigFunction('socials', [static::class, 'getField']));
        return $twig;
    }
    ...
    public static function getFields(): array
    {
        if (self::$_fields === null && function_exists('get_fields')) {
            self::$_fields = get_fields('socials') ?: [];
        }
        return self::$_fields ?? [];
    }
